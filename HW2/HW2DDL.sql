...
-- Mon 23 Sep 2019 07:57:12 PM MDT
...
-- -----------------------------------------------------
-- Table `mydb`.`Services&Materials`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`Services&Materials` ;

CREATE TABLE IF NOT EXISTS `mydb`.`Services&Materials` (
  `ServiceID` INT NOT NULL,
  `ServiceID` VARCHAR(128) NOT NULL,
  `MaterialsDelivered` VARCHAR(1024) NOT NULL,
  PRIMARY KEY (`ServiceID`),
  CONSTRAINT `fk_Services&Materials_Services&MaterialsDetails1`
    FOREIGN KEY (`ServiceID`)
    REFERENCES `mydb`.`Services&MaterialsDetails` (`ServiceID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
